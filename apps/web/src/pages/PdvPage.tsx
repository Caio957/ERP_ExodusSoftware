    ...
    <div className="grid h-full grid-cols-1 gap-5 lg:grid-cols-[1fr_400px]">
      ...
      <section className="flex flex-col gap-4">
        ...
        {search.trim().length < 2 ? (
          <div className="grid flex-1 place-items-center rounded-2xl border-2 border-dashed border-slate-200 p-10 text-center">
            <div>
              <ScanLine className="mx-auto mb-3 h-12 w-12 text-brand-300" />
              <p className="font-semibold text-slate-600">Pronto para vender</p>
              <p className="text-sm text-slate-400">
                Aponte o leitor ou digite ao menos 2 letras para buscar.
              </p>
            </div>
          </div>
        ) : (
              ...
              p.variants.map((v) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="mt-auto pt-2 text-lg font-bold text-brand-700">
                      {brl(v.salePrice)}
                    </span>
              ...
              {cart.map((it) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-slate-800">{brl(it.unitPrice * it.quantity)}</span>
                  </div>
                </li>
              ))}
            </ul>
